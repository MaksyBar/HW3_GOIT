...
def get_numbers_ticket(min, max, quantity):
  ...
  Аргументи:
    min: Ціле число - початковий номер діапазону (включно).
    max: Ціле число - кінцевий номер діапазону (включно).
  ...
  try:
    # Перевірка валідності діапазону
    if min > max:
      raise ValueError("Початковий номер діапазону не може бути більшим за кінцевий.")

    # Перевірка валідності кількості чисел
    if quantity > (max - min + 1):
      raise ValueError("Кількість чисел не може бути більшою за довжину діапазону.")

    # Генерація списку з усіма числами в діапазоні
...
Щоб виграти головний приз лотереї, необхідний збіг кількох номерів на лотерейному квитку з числами, що випали випадковим чином і в певному 
діапазоні під час чергового тиражу. Наприклад, необхідно вгадати шість чисел від 1 до 49 чи п'ять чисел від 1 до 36 тощо.
